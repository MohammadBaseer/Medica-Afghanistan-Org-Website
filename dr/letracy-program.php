...
<head>
    ...
    <title> برنامه ی سواد آموزی | میدیکا افغانستان</title>
...
<option value="../dr/letracy-program.php" selected>Dari</option>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">برنامه ی سواد آموزی</h1><!-- /.main-title main-title-alt -->

                            <ul class="breadcrumbs">
                                <li>
                                    <a href="#">ارتقای ظرفیت</a>
                                </li>

                                <li class="current">
                                    <a href="#">برنامه ی سواد آموزی</a>
                                </li><!-- /.current -->
                            </ul><!-- /.breadcrumbs -->
                        </div><!-- /.cell small-12 -->
                    </div>
...
<h3 dir="rtl"><strong>برنامه ی سواد آموزی</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM fr_web_records WHERE page_section = 'dr_letracy'" ;
