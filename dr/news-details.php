...
{
  $id = $_GET['news_view']; 
$sql = "SELECT * FROM en_home_page_news WHERE en_webhome_id='$id'";
...
<head>
    ...
    <title>  اخبار و برنامه ها | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/news-details.php">English</option>
<option value="../dr/news-details.php" selected>Dari</option>
<option value="../ps/news-details.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">اخبار و برنامه ها</h1><!-- /.main-title main-title-alt -->

                            <ul class="breadcrumbs">
                                <li>
                                    <a href="#">اخبار و برنامه ها</a>
                                </li>
...
<h3 dir="rtl"><strong>اخبار و برنامه ها</strong></h3>
<br>
...
<img src="../admin/data_pic/<?php echo $row['news_image'] ?>" alt="" class="img-responsive">
<br>
<p style="font-size: 13px;"><?php echo $row['news_dec']; ?><br></p>
