...
<head>
    ...
    <title> فعالیت های حقوقی | میدیکا افغانستان</title>
...
<option value="../dr/legal-activities.php" selected>Dari</option>
...
<h3 dir="rtl"><strong>فعالیت ها</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM fr_web_records WHERE page_section = 'dr_lap_activities'" ;
