...
<head>
    ...
    <title> خبرنامه | میدیکا افغانستان </title>
...
<option value="../dr/newsletters.php" selected>Dari</option>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">خبرنامه</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>خبرنامه</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM fr_web_records WHERE page_section = 'dr_newsletters'" ;
