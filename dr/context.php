...
<head>
    ...
    <title> پیشینه کاری ما | میدیکا افغانستان</title>
...
<option value="../dr/context.php" selected>Dari</option>
<option value="../ps/context.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">پیشینه کاری ما</h1><!-- /.main-title main-title-alt -->
