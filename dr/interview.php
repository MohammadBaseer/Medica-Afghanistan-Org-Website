...
<head>
    ...
    <title> مصاحبه ها | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/interview.php">English</option>
<option value="../dr/interview.php" selected>Dari</option>
<option value="../ps/interview.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">مصاحبه ها</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>مصاحبه ها</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM fr_web_records WHERE page_section = 'dr_interviews'" ;
