...
<head>
    ...
    <title>  گزارش ها روی تطبیق قانون منع حشونت علیه زنان | میدیکا افغانستان </title>
...
<option value="../dr/evaw-reports.php" selected>Dari</option>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">گزارش ها روی تطبیق قانون منع حشونت علیه زنان</h1><!-- /.main-title main-title-alt -->
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="current">
                                    <a href="#">گزارش ها روی تطبیق قانون منع حشونت علیه زنان</a>
                                </li><!-- /.current -->
                            </ul><!-- /.breadcrumbs -->
                        </div><!-- /.cell small-12 -->
                    </div>
...
<h3 dir="rtl"><strong>گزارش ها روی تطبیق قانون منع حشونت علیه زنان</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM fr_web_records WHERE page_section = 'dr_evaw_report'" ;
