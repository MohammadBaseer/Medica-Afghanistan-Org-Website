...
<head>
    ...
    <title> کتاب ها و جزوات | میدیکا افغانستان</title>
...
<option value="../dr/booklet.php" selected>Dari</option>
<option value="../ps/booklet.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">کتاب ها و جزوات</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>کتاب ها و جزوات</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM fr_web_records WHERE page_section = 'dr_booklet'" ;
