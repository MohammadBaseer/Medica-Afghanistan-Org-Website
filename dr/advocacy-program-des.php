...
<head>
    ...
    <title>  معرفی برنامه | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/advocacy-program-des.php">English</option>
<option value="../dr/advocacy-program-des.php" selected>Dari</option>
<option value="../ps/advocacy-program-des.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">معرفی برنامه</h1><!-- /.main-title main-title-alt -->
