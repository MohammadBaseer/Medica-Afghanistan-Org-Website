...
<head>
    ...
    <title>Letracy Program | Medica Afghanistan</title>
...
<option value="../ps/letracy-program.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="main-head">
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">Letracy Program</h1><!-- /.main-title main-title-alt -->
...
<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_letracy'";
...
href="../admin/data_files/files/<?php echo $row['files']; }?>"><?php echo $row['titile']; ?></a>
</il>
