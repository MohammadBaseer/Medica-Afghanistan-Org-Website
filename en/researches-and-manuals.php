...
<head>
	...
	<title>Researches and Manual | Medica Afghanistan</title>
...
<option value="../ps/researches-and-manuals.php">Pashto</option>
								</select>
							</li>
						</ul>
					</div>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Researches & Manuals</h1><!-- /.main-title main-title-alt -->
...
<h4><b>Researches and Manuals</b></h4>
<ol>


<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_researches'";
