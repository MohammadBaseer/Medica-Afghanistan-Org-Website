...
<head>
	...
	<title>Annual Report | Medica Afghanistan</title>
						...
						<ul>
							<li>
								<select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
									<option value="../en/annual-reports.php">English</option>
<option value="../dr/annual-reports.php">Dari</option>
<option value="../ps/annual-reports.php">Pashto</option>
								</select>
							</li>
						</ul>
					</div>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Annual Report</h1><!-- /.main-title main-title-alt -->
...
<h4><b>Annual Reports</b></h4>
<ol>

<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_annual_reports'";
...
?>
 ...
 href="../admin/data_files/files/<?php echo $row['files']; }?>"><?php echo $row['title']; ?></span></a></il>
