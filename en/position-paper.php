...
<head>
	...
	<title>Position Paper | Medica Afghanistan</title>
						...
						<ul>
							<li>
								<select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
									<option value="../en/position-paper.php">English</option>
<option value="../dr/position-paper.php">Dari</option>
<option value="../ps/position-paper.php">Pashto</option>
								</select>
							</li>
						</ul>
					</div>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Position Paper</h1><!-- /.main-title main-title-alt -->
...
<h4><b>Position Paper</b></h4>
<br>

<ol>

<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_position_paper'";
...
?>
 ...
 href="../admin/data_files/positions_files/<?php echo $row['files']; }?>"><?php echo $row['title']; ?></a></il>
