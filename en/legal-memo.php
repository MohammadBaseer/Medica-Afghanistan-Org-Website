...
<head>
	...
	<title>Legal Memo | Medica Afghanistan</title>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Legal Memo</h1><!-- /.main-title main-title-alt -->
...
<h4><b>Legal Memo</b></h4>
<br>
<ol>

<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_legal_memo'";
...
?>
 ...
 href="../admin/data_files/memo_files/<?php echo $row['file']; }?>"><?php echo $row['title']; ?></a></il>
