...
<head>
	...
	<title>Contact us | Medica Afghanistan</title>
						...
						<ul>
							<li>
								<select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
									<option value="../en/contact-us.php">English</option>
<option value="../dr/contact-us.php">Dari</option>
<option value="../ps/contact-us.php">Pashto</option>
	</select>
							</li>
						</ul>
					</div>
...
<p style="font-size: 13px;">Our Programs run with the help of generous donors like you. Your donation will help us continue changing Afghan women’s lives and getting a step closer to ending violence against women and helping the survivors recover</p><br>
                            <p style="font-size: 13px;">Please contact us if you would like to make a donation.</p><br>
                            <p style="font-size: 13px;">Email: <a href="mailto:Info@medica-afghanistan.org">Info@medica-afghanistan.org</a></p><br>
                            <p style="font-size: 13px;">Phone: 020-221-20-35</p><br>
