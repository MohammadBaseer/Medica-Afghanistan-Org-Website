...
<head>
    ...
    <title>Legal Services Activities | Medica Afghanistan</title>
...
<option value="../ps/legal-activities.php">Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="main-head">
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">Activities</h1><!-- /.main-title main-title-alt -->
...
<h4><b>Legal Services Activities</b></h4>
<br>
...
<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_lap_activities'";
