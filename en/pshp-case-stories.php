...
<head>
	...
	<title>Psychosocial Case Stories | Medica Afghanistan</title>
...
<option value="../ps/pshp-case-stories.php">Pashto</option>
								</select>
							</li>
						</ul>
					</div>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">PSHP Case Stories</h1><!-- /.main-title main-title-alt -->

							<ul class="breadcrumbs">
								<li>
									<a href="#">PSYCHOSOCIAL COUNSELING</a>
								</li>

								<li class="current">
									<a href="#">PSHP Case Stories</a>
								</li><!-- /.current -->
							</ul><!-- /.breadcrumbs -->
						</div><!-- /.cell small-12 -->
					</div>
...
<?php 
$i = 1;
$sql1 = "SELECT * FROM en_case_stories WHERE page_sec = 'PSHP' AND web_sec = 'English' "; 
