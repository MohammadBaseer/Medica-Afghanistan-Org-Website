...
<head>
	...
	<title>Newsletter | Medica Afghanistan</title>
						...
						<ul>
							<li>
								<select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
									<option value="../en/newsletters.php">English</option>
<option value="../dr/newsletters.php">Dari</option>
<option value="../ps/newsletters.php">Pashto</option>
								</select>
							</li>
						</ul>
					</div>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Newsletters</h1><!-- /.main-title main-title-alt -->
...
<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_newsletters'";
...
<?php if (empty($row['newsletters_files'])) {
...
?>
 ...
 href="../admin/data_files/newsletters_files/<?php echo $row['newsletters_files']; }?>"><?php echo $row['newsletters_title']; ?></a></il>
