...
<head>
	...
	<title>Statements | Medica Afghanistan</title>
						...
						<ul>
							<li>
								<select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
									<option value="../en/statements.php">English</option>
<option value="../dr/statements.php">Dari</option>
<option value="../ps/statements.php">Pashto</option>
								</select>
							</li>
						</ul>
					</div>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Statement</h1><!-- /.main-title main-title-alt -->
...
<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_statment'";
