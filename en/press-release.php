...
<head>
	...
	<title>Press Release | Medica Afghanistan</title>
		...
		<div class="main-head">
			...
			<div class="main-head-content">
				<div class="grid-container">
					<div class="grid-x grid-margin-x">
						<div class="cell small-12">
							<h1 class="main-title main-title-alt">Press Release</h1><!-- /.main-title main-title-alt -->
...
<?php 
$sql1 = "SELECT * FROM en_web_records WHERE page_section = 'en_press_release'";
