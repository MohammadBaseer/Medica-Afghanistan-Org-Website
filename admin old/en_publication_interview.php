...
if (empty($interview_title) || empty($interview_files)) {
?>
...
$sql = "INSERT INTO `en_pub_interview` (`user_id`, `interview_title`,`interview_files`, `record_date` ) VALUES ('$auth_id', '$interview_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">Interview</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"placeholder="Enter title" name="interview_title">
                  </div>
...
$sql1 = "SELECT * FROM   en_pub_interview JOIN users WHERE   en_pub_interview.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['interview_id']; ?></td>
                  <td><?php echo $row1['interview_title']; ?><a target="data_files/interview_files/<?php echo $row1['interview_files']; ?>" href="data_files/interview_files/<?php echo $row1['interview_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['interview_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/publication_interview_edit.php'; ?>
