...
$date = date('d M yy');
$statement_title   = $_POST ['statement_title'];
$statement_file = $_FILES ['statement_file']['name'];
$auth_id = $auth['id'];



if (empty($statement_title) || empty($statement_file)) {
?>
...
$sql = "INSERT INTO `en_legal_page_statement` (`user_id`, `legal_statement_title`,`legal_statement_file`, `record_date` ) VALUES ('$auth_id', '$statement_title', '$target_file', '$date');";
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="en_legal_position.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Legal Services</p>
                </a>
              </li>
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <h4>Legal Statements</h4>
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link" href="en_legal_position.php">Position Paper</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en-legal-memo.php">Legal Memo</a>
              </li>

              <li class="nav-item">
                <a class="nav-link active">Statement</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en-legal-case.php">Case Stories</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en-legal-activities.php">Activities</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="statement_title">
                  </div>
...
$sql1 = "SELECT * FROM en_legal_page_statement JOIN users WHERE en_legal_page_statement.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['en_legal_statement_id']; ?></td>
                  <td><?php echo $row1['legal_statement_title']; ?><a target="data_files/statement_files/<?php echo $row1['legal_statement_file']; ?>" href="data_files/statement_files/<?php echo $row1['legal_statement_file']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['en_legal_statement_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/legal_statement_edit.php'; ?>
