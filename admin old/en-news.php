...
if (empty($news_title) || empty($news_des) || empty($news_pic)) {
?>
...
$sql = "INSERT INTO `en_home_page_news` (`user_id`, `news_title`, `news_image`, `news_dec`, `record_date` ) VALUES ('$auth_id', '$news_title', '$news_pic', '$news_des', '$date');";
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="en-news.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Web Home Page</p>
                </a>
              </li>
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" href="en-current-pro.php">Our Current Programs</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" placeholder="Enter description ..." name="news_des"></textarea>
                      </div>
                  <div class="form-group">
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-hover" style="font-size: 14px;">
                ...
                <tbody>
                  ...
                  <!-- ============== -->
<?php 
$sql1 = "SELECT * FROM en_home_page_news JOIN users WHERE en_home_page_news.user_id = users.id";
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['en_webhome_id']; ?>"> 
