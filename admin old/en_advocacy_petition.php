...
if (empty($petitions_title) || empty($petitions_files)) {
?>
...
$sql = "INSERT INTO `en_petitions` (`user_id`, `petitions_title`,`petitions_files`, `record_date` ) VALUES ('$auth_id', '$petitions_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active" >Petitions</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="petitions_title">
                  </div>
...
$sql1 = "SELECT * FROM  en_petitions JOIN users WHERE  en_petitions.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['petitions_id']; ?></td>
                  <td><?php echo $row1['petitions_title']; ?><a target="data_files/petitions_files/<?php echo $row1['petitions_files']; ?>" href="data_files/petitions_files/<?php echo $row1['petitions_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['petitions_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/advocacy_petition_edit.php'; ?>
