...
if (empty($newsletters_title) || empty($newsletters_files)) {
?>
...
$sql = "INSERT INTO `en_pub_newsletters` (`user_id`, `newsletters_title`,`newsletters_files`, `record_date` ) VALUES ('$auth_id', '$newsletters_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">News Letters</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="newsletters_title">
                  </div>
...
$sql1 = "SELECT * FROM   en_pub_newsletters JOIN users WHERE   en_pub_newsletters.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['newsletters_id']; ?></td>
                  <td><?php echo $row1['newsletters_title']; ?><a target="data_files/newsletters_files/<?php echo $row1['newsletters_files']; ?>" href="data_files/newsletters_files/<?php echo $row1['newsletters_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<?php include 'controller/sections/en_section/publication_newsletters_edit.php'; ?>
