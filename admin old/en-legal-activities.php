...
if (empty($legal_act_title) || empty($legal_act_files)) {
?>
...
$sql = "INSERT INTO `en_legal_activities` (`user_id`, `legal_act_title`,`legal_act_files`, `record_date` ) VALUES ('$auth_id', '$legal_act_title', '$target_file', '$date');";
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" placeholder="Enter title" name="legal_act_title">
                  </div>
...
$sql1 = "SELECT * FROM en_legal_activities JOIN users WHERE en_legal_activities.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['legal_act_id']; ?></td>
                  <td><?php echo $row1['legal_act_title']; ?><a target="data_files/legal_act_files/<?php echo $row1['legal_act_files']; ?>" href="data_files/legal_act_files/<?php echo $row1['legal_act_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['legal_act_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/legal_activities_edit.php'; ?>
