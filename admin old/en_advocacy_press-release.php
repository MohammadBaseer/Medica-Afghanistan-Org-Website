...
$date = date('d M yy');
$press_release_title   = $_POST ['press_release_title'];
$press_release = $_FILES ['press_release']['name'];
$auth_id = $auth['id'];



if (empty($press_release_title) || empty($press_release)) {
?>
...
$target_file = time().'_'.basename($_FILES["press_release"]["name"]);
$fileupload ="data_files/press_releases_files/".$target_file;


$sql = "INSERT INTO `en_press_release` (`user_id`, `press_release_title`,`press_release_files`, `record_date` ) VALUES ('$auth_id', '$press_release_title', '$target_file', '$date');";

if($result = mysqli_query($conn,$sql))

{

move_uploaded_file($_FILES["press_release"]["tmp_name"], $fileupload)
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="en_advocacy_press-release.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Advocacy</p>
                </a>
              </li>
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active">Press Release</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en_advocacy_evaw_reports.php">EVAW Reports</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="en_advocacy_panel_code.php">Panel Codes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en_advocacy_petition.php">Petitions</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en_advocacy_other_legal_doc.php">Other Legal Doc</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="press_release_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="form-control-file" name="press_release">
                      </div>
...
$sql1 = "SELECT * FROM en_press_release JOIN users WHERE en_press_release.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['press_release_id']; ?></td>
                  <td><?php echo $row1['press_release_title']; ?><a target="data_files/press_releases_files/<?php echo $row1['press_release_files']; ?>" href="data_files/press_releases_files/<?php echo $row1['press_release_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['press_release_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/advocacy_press_relaese_edit.php'; ?>
