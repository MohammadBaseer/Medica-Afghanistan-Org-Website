...
?>
        <div class="modal fade" id="modal-edit<?php echo $row1['en_webhome_id']; ?>">
...
<div class="modal-body">
                 ...
                 <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" placeholder="Enter description ..." name="news_des" ><?php echo $row1['news_dec']; ?></textarea>
                      </div>
