<?php
// echo $mfile = $row1['legal_position_files'];
...
echo $mfile = $_POST['attachment'];
echo "<br><br>";
echo $target_file = time().'_'.basename($_FILES["position_file"]["name"]);
...
mysqli_query($conn, "UPDATE en_legal_position SET 
  ...
  legal_position_files   = '$target_file'
...
<!-- ==================================================== -->
<input type="hidden" class="form-control"  name="legal_position_id" value="<?php echo $row1['legal_position_id']; ?>">
