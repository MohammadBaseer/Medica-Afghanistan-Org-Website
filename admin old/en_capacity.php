...
$training_files = $_FILES ['training_files']['name'];
$auth_id = $auth['id'];



if (empty($training_title) || empty($training_files)) {
?>
...
$sql = "INSERT INTO `en_training` (`user_id`, `training_title`,`training_files`, `record_date` ) VALUES ('$auth_id', '$training_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active">Trainings</a>
              </li>   
              <li class="nav-item">
                <a class="nav-link" href="en_letracy_program.php">Letracy Program</a>
              </li>          
            </ul>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="training_title">
                  </div>
...
$sql1 = "SELECT * FROM   en_training JOIN users WHERE   en_training.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['training_id']; ?></td>
                  <td><?php echo $row1['training_title']; ?><a target="data_files/training_files/<?php echo $row1['training_files']; ?>" href="data_files/training_files/<?php echo $row1['training_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['training_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/training_edit.php'; ?>
