...
if (empty($memo_title) || empty($memo_file)) {
?>
...
$sql = "INSERT INTO `en_legal_page_legal_memo` (`user_id`, `legal_memo_title`,`legal_memo_file`, `record_date` ) VALUES ('$auth_id', '$memo_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">Legal Memo</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="memo_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="" name="memo_file">
...
$sql1 = "SELECT * FROM en_legal_page_legal_memo JOIN users WHERE en_legal_page_legal_memo.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['en_legal__memo_id']; ?></td>
                  <td><?php echo $row1['legal_memo_title']; ?><a target="data_files/memo_files/<?php echo $row1['legal_memo_file']; ?>" href="data_files/memo_files/<?php echo $row1['legal_memo_file']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['en_legal__memo_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/legal_memo_edit.php'; ?>
