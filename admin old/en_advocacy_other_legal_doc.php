...
if (empty($other_legal_doc_title) || empty($other_legal_doc_files)) {
?>
...
$sql = "INSERT INTO `en_other_legal_doc` (`user_id`, `other_legal_doc_title`,`other_legal_doc_files`, `record_date` ) VALUES ('$auth_id', '$other_legal_doc_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link" href="en_advocacy_press-release.php">Press Release</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active">Other Legal Doc</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="other_legal_doc_title">
                  </div>
...
$sql1 = "SELECT * FROM   en_other_legal_doc JOIN users WHERE   en_other_legal_doc.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['other_legal_doc_id']; ?></td>
                  <td><?php echo $row1['other_legal_doc_title']; ?><a target="data_files/other_legal_doc_files/<?php echo $row1['other_legal_doc_files']; ?>" href="data_files/other_legal_doc_files/<?php echo $row1['other_legal_doc_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['other_legal_doc_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/advocacy_oter_legal_doc_edit.php'; ?>
