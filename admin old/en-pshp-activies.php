...
if (empty($pshp_act_title) || empty($pshp_act_files)) {
?>
...
$sql = "INSERT INTO `en_pshp_activities` (`user_id`, `pshp_act_title`,`pshp_act_files`, `record_date` ) VALUES ('$auth_id', '$pshp_act_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <h4>Psychosocial Activities</h4>
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a href="en_phsp_case_stories.php" class="nav-link">PHSP Case Stories</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="pshp_act_title">
                  </div>
...
$sql1 = "SELECT * FROM   en_pshp_activities JOIN users WHERE   en_pshp_activities.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['pshp_act_id']; ?></td>
                  <td><?php echo $row1['pshp_act_title']; ?><a target="data_files/pshp_act_files/<?php echo $row1['pshp_act_files']; ?>" href="data_files/pshp_act_files/<?php echo $row1['pshp_act_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['pshp_act_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/pshp_activities_edit.php'; ?>
