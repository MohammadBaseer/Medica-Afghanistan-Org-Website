...
if (empty($position_title) || empty($position_file)) {
?>
...
$sql = "INSERT INTO `en_legal_position` (`user_id`, `legal_position_title`,`legal_position_files`, `record_date` ) VALUES ('$auth_id', '$position_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <h4>Legal Position Paper</h4>
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active">Position Paper</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="en-legal-statement.php">Statement</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="position_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="form-control-file" name="position_file">
                      </div>
...
$sql1 = "SELECT * FROM en_legal_position JOIN users WHERE en_legal_position.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['legal_position_id']; ?></td>
                  <td><?php echo $row1['legal_position_title']; ?><a target="data_files/positions_files/<?php echo $row1['legal_position_files']; ?>" href="data_files/positions_files/<?php echo $row1['legal_position_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['legal_position_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/legal_position_paper_edit.php'; ?>
