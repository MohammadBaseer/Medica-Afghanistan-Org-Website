...
if (empty($penal_code_title) || empty($penal_code_files)) {
?>
...
$sql = "INSERT INTO `en_penal_code` (`user_id`, `penal_code_title`,`penal_code_files`, `record_date` ) VALUES ('$auth_id', '$penal_code_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active" >Panel Codes</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="penal_code_title">
                  </div>
...
$sql1 = "SELECT * FROM  en_penal_code JOIN users WHERE  en_penal_code.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['panel_code_id']; ?></td>
                  <td><?php echo $row1['penal_code_title']; ?><a target="data_files/penal_code_files/<?php echo $row1['penal_code_files']; ?>" href="data_files/penal_code_files/<?php echo $row1['penal_code_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['panel_code_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/advocacy_panel_code_edit.php'; ?>
