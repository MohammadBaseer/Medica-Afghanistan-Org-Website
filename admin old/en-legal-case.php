...
if (empty($case_des) || empty($case_title)) {
?>
...
$sql = "INSERT INTO `en_legal_case` (`user_id`, `legal_case_title`,`legal_case_dec`, `record_date` ) VALUES ('$auth_id', '$case_title', '$case_des', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">Case Stories</a>
              </li>
              <li class="nav-item">
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-hover" style="font-size: 14px;">
                ...
                <tbody>
                  ...
                  <!-- ============== -->
<?php 
$sql1 = "SELECT * FROM  en_legal_case JOIN users WHERE  en_legal_case.user_id = users.id";
$query1 = mysqli_query($conn, $sql1);
while($row1 = mysqli_fetch_assoc($query1))
  {
?>
                <tr >
                  <td style="text-align: center;"><?php echo $row1['legal_case_id']; ?></td>
                  <td><?php echo $row1['legal_case_title']; ?></td>
                  <td><?php echo implode(' ', array_slice(explode(' ', $row1['legal_case_dec']), 0, 15))." ...". "\n"; ?></td>
                  <td><?php echo $row1['name']; ?></td>
                  <td><?php echo $row1['record_date']; ?></td>
                  

<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['legal_case_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/legal_case_story_edit.php'; ?>
