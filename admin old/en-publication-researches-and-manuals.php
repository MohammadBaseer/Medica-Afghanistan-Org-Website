...
$date = date('d M yy');
$researches_title   = $_POST ['researches_title'];
$researches_files = $_FILES ['researches_files']['name'];
$auth_id = $auth['id'];



if (empty($researches_title) || empty($researches_files)) {
?>
...
$target_file = time().'_'.basename($_FILES["researches_files"]["name"]);
$fileupload ="data_files/researches_files/".$target_file;


$sql = "INSERT INTO `en_pub_researches` (`user_id`, `researches_title`,`researches_files`, `record_date` ) VALUES ('$auth_id', '$researches_title', '$target_file', '$date');";

if($result = mysqli_query($conn,$sql))

{

move_uploaded_file($_FILES["researches_files"]["tmp_name"], $fileupload)
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <h4>Research & Munual</h4>
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">


              <li class="nav-item">
                <a class="nav-link" href="en-publication-annual-report.php">Annual Report</a>
              </li>    
              <li class="nav-item">
                <a class="nav-link active">Research & Manual</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="researches_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="form-control-file" name="researches_files">
                      </div>
...
$sql1 = "SELECT * FROM   en_pub_researches JOIN users WHERE   en_pub_researches.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['researches_id']; ?></td>
                  <td><?php echo $row1['researches_title']; ?><a target="data_files/researches_files/<?php echo $row1['researches_files']; ?>" href="data_files/researches_files/<?php echo $row1['researches_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['researches_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/publication_research_edit.php'; ?>
