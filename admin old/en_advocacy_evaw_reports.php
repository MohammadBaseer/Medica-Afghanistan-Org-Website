...
$evaw_reports_files = $_FILES ['evaw_reports_files']['name'];
$auth_id = $auth['id'];



if (empty($evaw_reports_title) || empty($evaw_reports_files)) {
?>
...
$sql = "INSERT INTO `en_evaw_reports` (`user_id`, `evaw_reports_title`,`evaw_reports_files`, `record_date` ) VALUES ('$auth_id', '$evaw_reports_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">EVAW Reports</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="evaw_reports_title">
                  </div>
...
$sql1 = "SELECT * FROM  en_evaw_reports JOIN users WHERE  en_evaw_reports.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['evaw_report_id']; ?></td>
                  <td><?php echo $row1['evaw_reports_title']; ?><a target="data_files/evaw_reports_files/<?php echo $row1['evaw_reports_files']; ?>" href="data_files/evaw_reports_files/<?php echo $row1['evaw_reports_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['evaw_report_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/advocacy_evaw_report_edit.php'; ?>
