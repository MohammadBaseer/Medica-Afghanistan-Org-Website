...
<head>
    ...
    <title> د سواد زده کری برنامه | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/letracy-program.php">English</option>
<option value="../dr/letracy-program.php">Dari</option>
<option value="../ps/letracy-program.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">د سواد زده کری برنامه</h1><!-- /.main-title main-title-alt -->

                            <ul class="breadcrumbs">
                                <li>
                                    <a href="#">د ظرفیت لورول</a>
                                </li>

                                <li class="current">
                                    <a href="#">د سواد زده کری برنامه</a>
                                </li><!-- /.current -->
                            </ul><!-- /.breadcrumbs -->
                        </div><!-- /.cell small-12 -->
                    </div>
...
<h3 dir="rtl"><strong>د سواد زده کری برنامه</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_letracy'" ;
