...
<head>
    ...
    <title> زمونږ سره اریکی | میدیکا افغانستان</title>
...
<option value="../ps/contact-us.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">زمونږ سره اریکی</h1><!-- /.main-title main-title-alt -->
...
<div class="container" style="padding: 5px;" dir="rtl">
    ...
    <h4><b>زمونږ سره اریکی</b></h4>

<br>
        <div class="col-lg-9 col-md-9 col-sm-9" style="float: right;">

 ایمیل آدرس : info@medica-afghanistan.org
