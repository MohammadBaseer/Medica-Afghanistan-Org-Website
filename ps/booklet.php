...
<head>
    ...
    <title> کتابونه، پوسترونه اپ مقالی | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/booklet.php">English</option>
<option value="../dr/booklet.php">Dari</option>
<option value="../ps/booklet.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">کتابونه، پوسترونه اپ مقالی</h1><!-- /.main-title main-title-alt -->
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="current">
                                    <a href="#">کتابونه، پوسترونه اپ مقالی</a>
                                </li><!-- /.current -->
                            </ul><!-- /.breadcrumbs -->
                        </div><!-- /.cell small-12 -->
                    </div>
...
<h3 dir="rtl"><strong>کتابونه، پوسترونه اپ مقالی</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_booklet'" ;
