...
<head>
    ...
    <title> زمونږ سره کار کوی | میدیکا افغانستان </title>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">زمونږ سره کار کوی</h1><!-- /.main-title main-title-alt -->
...
<br>
        ...
        <div class="container" data-aos="fade-down" style="direction: ltr;">
