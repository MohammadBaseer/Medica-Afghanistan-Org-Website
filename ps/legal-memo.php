...
<head>
    ...
    <title>  د حقوقی یاداشتونه | میدیکا افغانستان</title>
...
<option value="../dr/legal-memo.php">Dari</option>
<option value="../ps/legal-memo.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">د حقوقی یاداشتونه</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>د حقوقی یاداشتونه</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_legal_memo'" ;
