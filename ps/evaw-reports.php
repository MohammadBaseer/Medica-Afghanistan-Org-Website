...
<head>
    ...
    <title>  د ښځو پروړاندې د تاوتریخوالي له منځه وړلو  تطبیق د راپور | میدیکا افغانستان </title>
...
<option value="../ps/evaw-reports.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">د ښځو پروړاندې د تاوتریخوالي له منځه وړلو  تطبیق د راپور</h1><!-- /.main-title main-title-alt -->
                            ...
                            <ul class="breadcrumbs">
                                ...
                                <li class="current">
                                    <a href="#">د ښځو پروړاندې د تاوتریخوالي له منځه وړلو  تطبیق د راپور</a>
                                </li><!-- /.current -->
                            </ul><!-- /.breadcrumbs -->
                        </div><!-- /.cell small-12 -->
                    </div>
...
<h3 dir="rtl"><strong>د ښځو پروړاندې د تاوتریخوالي له منځه وړلو  تطبیق د راپور</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_evaw_report'" ;
