...
<head>
    ...
    <title> نور مسائل | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/other_doc.php">English</option>
<option value="../dr/other_doc.php">Dari</option>
<option value="../ps/other_doc.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">نور مسائل</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>نور مسائل</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_other_doc'" ;
