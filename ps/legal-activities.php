...
<head>
    ...
    <title> فعالیتونهی حقوقی | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/legal-activities.php">English</option>
<option value="../dr/legal-activities.php">Dari</option>
<option value="../ps/legal-activities.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">فعالیتونه</h1><!-- /.main-title main-title-alt -->
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_lap_activities'" ;
