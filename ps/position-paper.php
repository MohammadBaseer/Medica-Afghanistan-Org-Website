...
<head>
    ...
    <title> د موقف اسناد | میدیکا افغانستان </title>
...
<option value="../ps/position-paper.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">د موقف اسناد</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>د موقف اسناد</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_position_paper'" ;
