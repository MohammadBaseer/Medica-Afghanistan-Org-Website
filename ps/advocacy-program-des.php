                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/advocacy-program-des.php.php">English</option>
<option value="../dr/advocacy-program-des.php.php">Dari</option>
<option value="../ps/advocacy-program-des.php.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
