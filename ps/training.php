...
<head>
    ...
    <title> تریننگ | میدیکا افغانستان</title>
...
<option value="../dr/training.php">Dari</option>
<option value="../ps/training.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">تریننگ</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>تریننگ</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_trainings'" ;
