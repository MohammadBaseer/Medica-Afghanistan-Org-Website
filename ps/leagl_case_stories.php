...
<head>
    ...
    <title>  د دوسیی نمونه | میدیکا افغانستان</title>
...
<option value="../ps/leagl_case_stories.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">د دوسیی نمونه</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>د دوسیی نمونه</strong></h3>
<br>
