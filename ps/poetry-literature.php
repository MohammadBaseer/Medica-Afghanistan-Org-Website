...
<head>
    ...
    <title> شعر او ادب | میدیکا افغانستان</title>
...
<option value="../ps/poetry-literature.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">شعر او ادب</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>شعر او ادب</strong></h3>
<br>
