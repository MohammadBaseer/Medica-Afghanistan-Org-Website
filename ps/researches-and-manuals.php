...
<head>
    ...
    <title> څیړنه او لاسود | میدیکا افغانستان</title>
                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/researches-and-manuals.php">English</option>
<option value="../dr/researches-and-manuals.php">Dari</option>
<option value="../ps/researches-and-manuals.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">څیړنه او لاسود</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>څیړنه او لاسود</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_researches'" ;
