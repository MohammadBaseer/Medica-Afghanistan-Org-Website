...
<head>
    ...
    <title>  فعالیتونه | میدیکا افغانستان</title>
...
<option value="../dr/pshp-activities.php">Dari</option>
<option value="../ps/pshp-activities.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            ...
                            <ul class="breadcrumbs">
                                <li>
                                    <a href="#">صحت و ردانی درملنه برخه</a>
                                </li>
...
<h3 dir="rtl"><strong>فعالیتونه</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_pshp_activities'" ;
