...
<head>
    ...
    <title> مطبوعاتی اعلانی | میدیکا افغانستان </title>
...
<option value="../dr/petitions.php">Dari</option>
<option value="../ps/petitions.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">مطبوعاتی اعلانی</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>مطبوعاتی اعلانی</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_petitions'" ;
