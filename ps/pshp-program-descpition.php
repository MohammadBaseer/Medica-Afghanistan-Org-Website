                        ...
                        <ul>
                            <li>
                                <select name="forma" onchange="location = this.value;" style="height: 4.4375rem; border: none; background-color: #FBFBFB;">
                                    <option value="../en/pshp-program-descpition.php">English</option>
<option value="../dr/pshp-program-descpition.php">Dari</option>
<option value="../ps/pshp-program-descpition.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
