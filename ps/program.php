...
<head>
    ...
    <title>  زمونږ فعلی پروگرامونه | میدیکا افغانستان</title>
...
<option value="../ps/program.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">زمونږ فعلی پروگرامونه</h1><!-- /.main-title main-title-alt -->

                            <ul class="breadcrumbs">
                                <li>
                                    <a href="#">زمونږ فعلی پروگرامونه</a>
                                </li>
...
<h3 dir="rtl"><strong>زمونږ فعلی پروگرامونه</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM en_home_page_pro WHERE web_sec ='Dari' ";
