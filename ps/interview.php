...
<head>
    ...
    <title> مصاحبه | میدیکا افغانستان</title>
...
<option value="../dr/interview.php">Dari</option>
<option value="../ps/interview.php" selected>Pashto</option>
                                </select>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="main-head-content">
                <div class="grid-container">
                    <div class="grid-x grid-margin-x" style="direction: rtl;">
                        <div class="cell small-12">
                            <h1 class="main-title main-title-alt">مصاحبه</h1><!-- /.main-title main-title-alt -->
...
<h3 dir="rtl"><strong>مصاحبه</strong></h3>
<br>
...
<?php 
$sql1 = "SELECT * FROM ps_web_records WHERE page_section = 'ps_interviews'" ;
