...
$sql = "INSERT INTO `fr_web_records` (`user_id`, `title`,`files`,`page_section`, `record_date` ) VALUES ('$auth_id', '$title','$target_file','$page_section', '$date');";
...
<option value="dr_pshp_activities">Activities</option>
</optgroup>


<optgroup label="Legal Services">
<option value="dr_position_paper">Position Paper</option>
<option value="dr_legal_memo">Legal Memo</option>
<option value="dr_lap_activities">Activities</option>
</optgroup>

<optgroup label="Advocacy">
<option value="dr_press_release">Press Release</option>
<option value="dr_evaw_report">EVAW Reports</option>
<option value="dr_petitions">Petitions</option>
<option value="dr_statment">Statements</option>
<option value="dr_other_doc">Other Documents</option>
</optgroup>

<optgroup label="News & Events">
<option value="dr_newsletters">Newsletters</option>
</optgroup>

<optgroup label="Capacity Building">
<option value="dr_trainings">Trainings</option>
<option value="dr_letracy">Letracy Program</option>
</optgroup>

<optgroup label="Publications">
<option value="dr_annual_reports">Annual Reports</option>
<option value="dr_researches">Researches and Manuals</option>
<option value="dr_booklet">Booklet and Magazines</option>
<option value="dr_poetry">Poetry and Literature</option>
<option value="dr_interviews">Interviews</option>
</optgroup>
  </select>
                  </div>
...
<?php 
$i = 1;
$sql1 = "SELECT * FROM fr_web_records JOIN users WHERE fr_web_records.user_id = users.id ORDER BY record_id DESC";
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" href="dr_edit_page_records.php?edit=<?php echo $row1['record_id']; ?>"> 
