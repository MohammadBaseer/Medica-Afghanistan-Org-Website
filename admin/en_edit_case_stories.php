...
$sql = mysqli_query($conn,"SELECT * FROM en_case_stories WHERE record_id  = $edit");
$row1 = mysqli_fetch_assoc($sql);
// ======================================
 if (isset($_POST['update']))
 {
$case_title   = $_POST ['case_title'];
$case_dec = $_POST ['case_dec'];
$page_sec = $_POST ['page_sec'];
$lang = $_POST ['lang'];

if (mysqli_query($conn, "UPDATE en_case_stories SET 
...
<?php
echo "<script>window.location='en_case_stories.php';</script>";
...
<!-- ============================================================== -->
            <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" required name="case_title" value="<?php echo $row1['case_title']; ?>">
                  </div>
                 <div class="form-group">
                        <label>Case Description</label>
                        <textarea id="editor1" class="form-control" rows="4" placeholder="Enter description ..." name="case_dec" required><?php echo $row1['case_dec']; ?></textarea>
                      </div>
...
<option value="PSHP" <?php if ($row1['page_sec'] == 'PSHP') { echo 'selected';} ?>>PSHP Case</option>
  </optgroup>
   <optgroup label="Legal Services">
<option value="LAP" <?php if ($row1['page_sec'] == 'LAP') { echo 'selected';} ?>>LAP Case</option>
  </optgroup>
</select>
</div>
