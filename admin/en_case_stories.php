...
<?php 
$sql1 = "SELECT * FROM en_case_stories JOIN users WHERE en_case_stories.user_id = users.id ORDER BY record_id DESC";
...
$sql = "INSERT INTO `en_case_stories` (`user_id`, `case_title`,`case_dec`,`page_sec`,`web_sec`, `record_date` ) VALUES ('$auth_id', '$case_title', '$case_des','$page_sec','$lang', '$date');";
...
?>
                <tr >
                  ...
                  <td><?php echo $row1['case_title']; ?></td>
                  <td><?php echo implode(' ', array_slice(explode(' ', $row1['case_dec']), 0, 15))." ...". "\n"; ?></td>
                  <td><?php echo $row1['page_sec']; ?></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" href="en_edit_case_stories.php?edit=<?php echo $row1['record_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php //include 'controller/sections/en_section/case_story_edit.php'; ?>
