...
$sql = mysqli_query($conn,"SELECT * FROM en_home_page_pro WHERE en_webhome_pr_id  = $edit");
...
<?php
echo "<script>window.location='en_our_programs.php';</script>";
...
<div class="modal-body">
                 ...
                 <div class="form-group">
                        ...
                        <textarea id="editor1" class="form-control" rows="4" placeholder="Enter description ..." name="pro_des" required><?php echo $row1['pro_dec']; ?></textarea>
                      </div>
