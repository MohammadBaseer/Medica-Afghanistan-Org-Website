...
$letracy_pro_files = $_FILES ['letracy_pro_files']['name'];
$auth_id = $auth['id'];



if (empty($letracy_pro_titile) || empty($letracy_pro_files)) {
?>
...
$sql = "INSERT INTO `en_capacity_letracy_pro` (`user_id`, `letracy_pro_titile`,`letracy_pro_files`, `record_date` ) VALUES ('$auth_id', '$letracy_pro_titile', '$target_file', '$date');";
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="en_capacity.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            <h4>Letracy Program</h4>
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link" href="en_capacity.php">Trainings</a>
              </li>   
              <li class="nav-item">
                <a class="nav-link active">Letracy Program</a>
              </li>          
            </ul>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="letracy_pro_titile">
                  </div>
...
$sql1 = "SELECT * FROM   en_capacity_letracy_pro JOIN users WHERE   en_capacity_letracy_pro.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['letracy_pro_id']; ?></td>
                  <td><?php echo $row1['letracy_pro_titile']; ?><a target="data_files/letracy_pro_files/<?php echo $row1['letracy_pro_files']; ?>" href="data_files/letracy_pro_files/<?php echo $row1['letracy_pro_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['letracy_pro_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/letracy-program_edit.php'; ?>
