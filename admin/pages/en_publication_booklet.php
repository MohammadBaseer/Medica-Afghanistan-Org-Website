...
$date = date('d M yy');
$booklet_title   = $_POST ['booklet_title'];
$booklet_files = $_FILES ['booklet_files']['name'];
$auth_id = $auth['id'];



if (empty($booklet_title) || empty($booklet_files)) {
?>
...
$target_file = time().'_'.basename($_FILES["booklet_files"]["name"]);
$fileupload ="data_files/booklet_files/".$target_file;


$sql = "INSERT INTO `en_booklet` (`user_id`, `booklet_title`,`booklet_files`, `record_date` ) VALUES ('$auth_id', '$booklet_title', '$target_file', '$date');";

if($result = mysqli_query($conn,$sql))

{

move_uploaded_file($_FILES["booklet_files"]["tmp_name"], $fileupload)
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">Booklet</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"placeholder="Enter title" name="booklet_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="form-control-file" name="booklet_files">
                      </div>
...
$sql1 = "SELECT * FROM   en_booklet JOIN users WHERE   en_booklet.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['booklet_id']; ?></td>
                  <td><?php echo $row1['booklet_title']; ?><a target="data_files/booklet_files/<?php echo $row1['booklet_files']; ?>" href="data_files/booklet_files/<?php echo $row1['booklet_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['booklet_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/publication_booklet_edit.php'; ?>
