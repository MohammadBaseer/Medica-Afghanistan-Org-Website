...
$annual_report_files = $_FILES ['annual_report_files']['name'];
$auth_id = $auth['id'];



if (empty($annual_report_title) || empty($annual_report_files)) {
?>
...
$target_file = time().'_'.basename($_FILES["annual_report_files"]["name"]);
$fileupload ="data_files/annual_report_files/".$target_file;


$sql = "INSERT INTO `en_pub_annual_report` (`user_id`, `annual_report_title`,`annual_report_files`, `record_date` ) VALUES ('$auth_id', '$annual_report_title', '$target_file', '$date');";

if($result = mysqli_query($conn,$sql))

{

move_uploaded_file($_FILES["annual_report_files"]["tmp_name"], $fileupload)
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="en_phsp_case_stories.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PSHP</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="en-publication-annual-report.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Publication</p>
                </a>
              </li>
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active">Annual Report</a>
              </li>    
              <li class="nav-item">
                <a class="nav-link" href="en-publication-researches-and-manuals.php">Research & Manual</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en_publication_booklet.php">Booklet</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en-publication-newsletters.php">News Letters</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en-publiction-poetry-literature.php">Poetry & Literature</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="en_publication_interview.php">Interview</a>
              </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="annual_report_title">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="form-control-file" name="annual_report_files">
                      </div>
...
$sql1 = "SELECT * FROM   en_pub_annual_report JOIN users WHERE   en_pub_annual_report.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['annual_report_id']; ?></td>
                  <td><?php echo $row1['annual_report_title']; ?><a target="data_files/annual_report_files/<?php echo $row1['annual_report_files']; ?>" href="data_files/annual_report_files/<?php echo $row1['annual_report_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['annual_report_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/publication_annual_report_edit.php'; ?>
