...
if (empty($poetry_literature_title) || empty($poetry_literature_files)) {
?>
...
$sql = "INSERT INTO `en_pub_poetry_literature` (`user_id`, `poetry_literature_title`,`poetry_literature_files`, `record_date` ) VALUES ('$auth_id', '$poetry_literature_title', '$target_file', '$date');";
...
<div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active" >Poetry & Literature</a>
              </li>
              <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="poetry_literature_title">
                  </div>
...
$sql1 = "SELECT * FROM   en_pub_poetry_literature JOIN users WHERE   en_pub_poetry_literature.user_id = users.id ";
...
while($row1 = mysqli_fetch_assoc($query1))
  {
    ?>
                ...
                <tr >
                  <td style="text-align: center;"><?php echo $row1['poetry_literature_id']; ?></td>
                  <td><?php echo $row1['poetry_literature_title']; ?><a target="data_files/poetry_literature_files/<?php echo $row1['poetry_literature_files']; ?>" href="data_files/poetry_literature_files/<?php echo $row1['poetry_literature_files']; ?>">&nbsp;&nbsp;Link</a></td>
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['poetry_literature_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/publiction_poetry_literature_edit.php'; ?>
