          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" placeholder="Enter description ..." name="pro_des"></textarea>
                      </div>
                  <div class="form-group">
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-hover" style="font-size: 14px;">
                ...
                <tbody>
                  ...
                  <!-- ============== -->
<?php 
// $sql1 = "SELECT * FROM en_home_page_pro JOIN users WHERE en_home_page_pro.user_id = users.id";
$sql1 = "SELECT * FROM en_home_page_pro";
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" data-toggle="modal" data-target="#modal-edit<?php echo $row1['en_webhome_pr_id']; ?>"> 
                        <i class="feather icon-edit" aria-hidden="true" style="color: #0bd83a;" title="Edit"></i>
                </a><!-- &nbsp;&nbsp; -->
<?php include 'controller/sections/en_section/pro_edit_modal.php'; ?>
