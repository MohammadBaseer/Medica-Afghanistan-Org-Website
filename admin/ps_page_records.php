...
$sql = "INSERT INTO `ps_web_records` (`user_id`, `title`,`files`,`page_section`, `record_date` ) VALUES ('$auth_id', '$title','$target_file','$page_section', '$date');";
...
<option value="ps_pshp_activities">Activities</option>
</optgroup>


<optgroup label="Legal Services">
<option value="ps_position_paper">Position Paper</option>
<option value="ps_legal_memo">Legal Memo</option>
<option value="ps_lap_activities">Activities</option>
</optgroup>

<optgroup label="Advocacy">
<option value="ps_press_release">Press Release</option>
<option value="ps_evaw_report">EVAW Reports</option>
<option value="ps_petitions">Petitions</option>
<option value="ps_statment">Statements</option>
<option value="ps_other_doc">Other Documents</option>
</optgroup>

<optgroup label="News & Events">
<option value="ps_newsletters">Newsletters</option>
</optgroup>

<optgroup label="Capacity Building">
<option value="ps_trainings">Trainings</option>
<option value="ps_letracy">Letracy Program</option>
</optgroup>

<optgroup label="Publications">
<option value="ps_annual_reports">Annual Reports</option>
<option value="ps_researches">Researches and Manuals</option>
<option value="ps_booklet">Booklet and Magazines</option>
<option value="ps_poetry">Poetry and Literature</option>
<option value="ps_interviews">Interviews</option>
</optgroup>
  </select>
                  </div>
...
<?php 
$i = 1;
$sql1 = "SELECT * FROM ps_web_records JOIN users WHERE ps_web_records.user_id = users.id ORDER BY record_id DESC";
...
<td style="text-align: center;"><!-- &nbsp;&nbsp; -->
                <a type="button" href="ps_edit_page_records.php?edit=<?php echo $row1['record_id']; ?>"> 
